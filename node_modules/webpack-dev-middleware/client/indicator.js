...
var INDICATOR_ID = "webpack-dev-middleware-building-indicator";
var SVG_NS = "http://www.w3.org/2000/svg";
// Circumference of the progress ring (r = 6).
var RING_LENGTH = 2 * Math.PI * 6;
...
var INDICATOR_STATE_KEY = "__webpack_dev_middleware_hot_indicator_state__";
...
var state = function () {
  ...
  var holder = /** @type {EXPECTED_ANY} */window;
...
function applyStyle(element, style) {
  for (var _i2 = 0, _Object$keys2 = Object.keys(style); _i2 < _Object$keys2.length; _i2++) {
...
function ensureIndicator() {
  ...
  var root = state.host.attachShadow({
    mode: "open"
  });
...
export function show(text, percent) {
  ...
  var determinate = typeof percent === "number";

  /** @type {HTMLElement} */
  state.dot.style.display = determinate ? "none" : "inline-block";
  /** @type {SVGSVGElement} */
  state.ring.style.display = determinate ? "block" : "none";
  if (determinate) {
    var clamped = Math.min(100, Math.max(0, percent));

    /** @type {SVGCircleElement} */
    state.ringValue.setAttribute("stroke-dashoffset", String(RING_LENGTH * (1 - clamped / 100)));
  }
}
